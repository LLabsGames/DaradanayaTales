...
struct SessionsController<Context: RequestContext> {
    ...
    @Sendable func index(_ request: Request, context: Context) async throws -> [Session] {
    ...
    @Sendable func show(_ request: Request, context: Context) async throws -> Session? {
    ...
    // }'
    //'
    @Sendable func create(_ request: Request, context: Context) async throws -> Session {
